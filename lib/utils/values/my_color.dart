...
class MyColors {
  // Primary Colors
  static const Color bgDark = Color.fromRGBO(22, 27, 39, 1);
  static const Color bgLight = Color.fromRGBO(29, 36, 48, 1);
  static const Color primary = Color.fromRGBO(37, 47, 64, 1);
  static const Color lightGrey = Color.fromRGBO(53, 63, 84, 1);
  static const Color mediumGrey = Color.fromRGBO(20, 27, 36, 1);
  ...
  static const Color darkBtnBlack = Color.fromRGBO(20, 27, 36, 1);
  ...
  static const Color orangeGradientStart = Color(
    0xFFFF6D00,
  ); // rgba(255, 109, 0, 1)
  static const Color orangeGradientEnd = Color(
    0xFFFFA000,
  ); // rgba(255, 160, 0, 1)
  static const Color bronzeGradientStart = Color(
    0xFF8C7B00,
  ); // rgba(140, 123, 0, 1)
  static const Color bronzeGradientEnd = Color(
    0xFFFFA726,
  ); // rgba(255, 167, 38, 1)
  static const Color blueGrayGradientStart = Color(
    0xFF90A4AE,
  ); // rgba(144, 164, 174, 1)
  static const Color blueGrayGradientEnd = Color(
    0xFFCFD8DC,
  ); // rgba(207, 216, 220, 1)
